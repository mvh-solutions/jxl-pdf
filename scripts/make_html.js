...
if (config.frontMatter) {
    ...
    const frontMatter = fse.readFileSync(path.join('data', config.frontMatter + '.html')).toString();
    sentences.push(frontMatter);
}
let chapterN = "0";
sentences.push(maybeChapterNotes("front", "book"));
