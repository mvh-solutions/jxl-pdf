...
const setupCSS = options => {
    ...
    for (const filename of cssFilenames) {
        ...
        for (const [placeholder, value] of [
            ...
            ["20PCWIDTH", (pageBodyWidth - (pageFormat.columnGap[spaceOption] * 2)) * 0.2],
            ["30PCWIDTH", (pageBodyWidth - (pageFormat.columnGap[spaceOption] * 2)) * 0.3],
            ["35PCWIDTH", (pageBodyWidth - (pageFormat.columnGap[spaceOption] * 2)) * 0.35],
            ["40PCWIDTH", (pageBodyWidth - (pageFormat.columnGap[spaceOption] * 2)) * 0.4],
            ["45PCWIDTH", (pageBodyWidth - (pageFormat.columnGap[spaceOption] * 2)) * 0.45],
